...
4. **Имя блока с эмодзи** — при автогруппировке имя блока включает epic_emoji (например, «💼 Работа» вместо «Работа»)
...
- [ ] preferred_time-группировка задач удалена в v1.2.0 — неактуально
